...
import entities.Pneus;

public class AppLoja {
	
	
	public static Pneus lp = new Pneus();
	...
	public static void programInit() {
		...
		Lines(70);
		Jump(1);
		System.out.print("Deseja comprar conosco(C) ou adicionar novos produtos(A)???");
	...
	private static void Receipt(){
	    {
	        ...
	        AppLoja.Lines(75);
	        AppLoja.Jump(1);
	        System.out.println("Código\t\tProduto\t\t\tValor\tQuantidade\tMargem de Lucro");
	        AppLoja.Lines(75);
	        for(Pneus x : lp.list) {
	            if(x.getCart() > 0) {
	                System.out.println( x.toStringCart());
